    ...
    <div v-if="!loading">
      ...
      <v-card elevation="0">
        <v-toolbar class="mb-2" dense flat>
          <v-toolbar-title><span>Delivery Men</span></v-toolbar-title>
          <span>
            <v-btn
              dense
              class="ma-0 px-0"
          ...
          <v-spacer></v-spacer>
          <CommunityDeliveryCreate @success="handleSuccessResponse" />
        </v-toolbar>
        <v-data-table
          dense
          :headers="headers"
              ...
              <v-list width="150" dense>
                <v-list-item>
                  <v-list-item-title style="cursor: pointer">
                    <CommunityDeliveryEdit  :item="item" @success="handleSuccessResponse" />
                  </v-list-item-title>
                </v-list-item>
                <v-list-item>
                  <v-list-item-title style="cursor: pointer">
                    <CommunityDeliverySingle
