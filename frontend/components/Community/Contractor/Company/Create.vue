<template>
  <v-dialog persistent v-model="dialog" width="900">
    ...
    <v-card>
      <v-card-title>Add Contractor Company</v-card-title>
      <v-container>
        <v-row>
          <v-col cols="3">
            <v-row>
            ...
            <v-row>
              ...
              <v-col cols="6">
                <v-text-field
                  ...
                  :error-messages="
                    errors && errors.mobile_number ? errors.mobile_number[0] : ''
                  "
                ></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-text-field
                  ...
                  :error-messages="errors && errors.licence_number ? errors.licence_number[0] : ''"
                ></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-text-field
                  ...
                  :error-messages="errors && errors.licence_issue_by_department ? errors.licence_issue_by_department[0] : ''"
                ></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-menu
                ...
                >
                  <template v-slot:activator="{ on, attrs }">
                    <v-text-field
                      ...
                      :error-messages="
                        errors && errors.licence_expiry ? errors.licence_expiry[0] : ''
                      "
                    ></v-text-field>
                  </template>
                  <v-date-picker
              ...
              <v-col cols="4">
                <v-text-field
                  ...
                  :error-messages="errors && errors.car_number ? errors.car_number[0] : ''"
                ></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-text-field
                  ...
                  :error-messages="errors && errors.car_brand ? errors.car_brand[0] : ''"
                ></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-text-field
                  ...
                  :error-messages="errors && errors.car_issued_city ? errors.car_issued_city[0] : ''"
                ></v-text-field>
              </v-col>
